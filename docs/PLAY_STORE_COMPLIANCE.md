...
- [ ] Write the actual Privacy Policy (needs LocalToNet + Adsterra disclosures, plus auth data once decided).
- [ ] Draft app store listing copy, review against Deceptive Behavior policy before publishing.
- [ ] Fill out the Play Console Data Safety form once integrations are final.
